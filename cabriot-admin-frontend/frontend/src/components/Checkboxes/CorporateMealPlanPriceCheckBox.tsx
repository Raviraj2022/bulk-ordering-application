...
const CorporateMealPlanPriceCheckbox: React.FC<MealPlanPriceCheckboxProps> = ({name, checkBoxId, onChange, checkboxDisabled, DaysDishValue}) => {
...
export default CorporateMealPlanPriceCheckbox;
