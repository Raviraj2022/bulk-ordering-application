            ...
            <table className="w-full table-auto">
              <thead>
                <tr className="bg-gray-2 text-left dark:bg-meta-4">
                  <th className="min-w-[120px] py-4 px-2 font-medium text-black dark:text-white xl:pl-5">
                    Kitchen
                  </th>
                  ...
                  <th className="min-w-[120px] py-4 pl-11 font-medium text-black dark:text-white">
                    Actions
                  </th>
                </tr>
              </thead>
                      ...
                      <ul>
                        {item.kitchen_menus.map((menus, kitchenIndex) => (
                          <li key={kitchenIndex}>
                            {menus.dish_name}
                            {menus.meal_name}
                          </li> // Assuming kitchen has a name field
                        ))}
                      </ul>
                    </td>
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark ">
