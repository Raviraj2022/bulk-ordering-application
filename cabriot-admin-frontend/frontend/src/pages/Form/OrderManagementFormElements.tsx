...
import UserOrderDataTable from '../../components/Tables/UserOrdersDataTable';
...
const OrderManagementFormElements = () => {
  ...
  const [monthly_breakfast_price, Set_monthly_breakfast_price] =
    useState(false);
  ...
  const [wednesday_breakfast_dish, Set_wednesday_breakfast_dish] =
    useState(false);
  const [wednesday_breakfast_meal, Set_wednesday_breakfast_meal] =
    useState(false);
  ...
  const [thursday_breakfast_dish, Set_thursday_breakfast_dish] =
    useState(false);
  const [thursday_breakfast_meal, Set_thursday_breakfast_meal] =
    useState(false);
  ...
  const [saturday_breakfast_dish, Set_saturday_breakfast_dish] =
    useState(false);
  const [saturday_breakfast_meal, Set_saturday_breakfast_meal] =
    useState(false);
                ...
                <div className="button flex items-center">
                  ...
                  >
                    <Icon
                      ...
                      color="inherit"
                    />
                    <span>Add User Order</span>
                  </button>
                </div>
              </div>
            </div>
          )}
          <UserOrderDataTable handleEditForm={handleEditForm} />
        </>
      ) : (
        <>
                      ...
                      <div className="">
                        ...
                        <label className="switch">
                          <input
                            type="checkbox"
                            checked={
                              formData.meal_plan_availability_status ===
                              'available'
                            }
                            onChange={(e) =>
                              setFormData({
                                ...formData,
                                meal_plan_availability_status: e.target.checked
                                  ? 'available'
                                  : 'unavailable',
                              })
                            }
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8.5 p-6.5">
                    <div className="gap-3 rounded-lg border border-stroke px-5 pt-1 pb-4 item-center justify-center">
                        ...
                        <div className="w-25">
                          ...
                          >
                            <MealPlanPricingCheckBox
                              ...
                              DaysDishValue={daily_price}
                              checkBoxId={'daily_price'}
                              name={'Daily'}
                            />
                          </label>
                        </div>
                      ...
                      <div className="gap-3 flex space-evenly">
                        <div className="w-25">
                          <label
                            htmlFor="daily_breakfast_price"
                            className="mb-3 mt-4 block text-black dark:text-white pt-2"
                          >
                            <MealPlanPricingCheckBox
                              onChange={handlePricingCheckBox}
                              checkBoxId={'daily_breakfast_price'}
                              name={'BreakFast'}
                            />
                          </label>
                        </div>
                      ...
                      <div className="gap-3 flex space-evenly">
                        <div className="w-25">
                          <label
                            htmlFor="daily_dinner_price"
                            className="mb-3 mt-4 block text-black dark:text-white pt-2"
                          >
                            <MealPlanPricingCheckBox
                              onChange={handlePricingCheckBox}
                              checkBoxId={'daily_dinner_price'}
                              name={'Dinner'}
                            />
                          </label>
                        </div>
                    ...
                    <div className="gap-3 rounded-lg border border-stroke px-5 pt-1 pb-4 item-center justify-center">
                      <div className="gap-3 flex space-evenly">
                        <div className="w-25">
                          <label
                            htmlFor="weekly_price"
                            className="mb-3 mt-4 block text-black dark:text-white pt-2"
                          >
                            <MealPlanPricingCheckBox
                              onChange={handlePricingCheckBox}
                              checkBoxId={'weekly_price'}
                              name={'Weekly'}
                            />
                          </label>
                        </div>
                      ...
                      <div className="gap-3 flex space-evenly">
                        <div className="w-25">
                          <label
                            htmlFor="weekly_breakfast_price"
                            className="mb-3 mt-4 block text-black dark:text-white pt-2"
                          >
                            <MealPlanPricingCheckBox
                              onChange={handlePricingCheckBox}
                              checkBoxId={'weekly_breakfast_price'}
                              name={'BreakFast'}
                            />
                          </label>
                        </div>
                      ...
                      <div className="gap-3 flex space-evenly">
                        <div className="w-25">
                          <label
                            htmlFor="weekly_lunch_price"
                            className="mb-3 mt-4 block text-black dark:text-white pt-2"
                          >
                            <MealPlanPricingCheckBox
                              onChange={handlePricingCheckBox}
                              checkBoxId={'weekly_lunch_price'}
                              name={'Lunch'}
                            />
                          </label>
                        </div>
                      ...
                      <div className="gap-3 flex space-evenly">
                        <div className="w-25">
                          <label
                            htmlFor="weekly_dinner_price"
                            className="mb-3 mt-4 block text-black dark:text-white pt-2"
                          >
                            <MealPlanPricingCheckBox
                              onChange={handlePricingCheckBox}
                              checkBoxId={'weekly_dinner_price'}
                              name={'Dinner'}
                            />
                          </label>
                        </div>
                    ...
                    <div className="gap-3 rounded-lg border border-stroke px-5 pt-1 pb-4 item-center justify-center">
                      ...
                      <div className="gap-3 flex space-evenly">
                        <div className="w-25">
                          <label
                            htmlFor="monthly_breakfast_price"
                            className="mb-3 mt-4 block text-black dark:text-white pt-2"
                          >
                            <MealPlanPricingCheckBox
                              onChange={handlePricingCheckBox}
                              checkBoxId={'monthly_breakfast_price'}
                              name={'BreakFast'}
                            />
                          </label>
                        </div>
                      ...
                      <div className="gap-3 flex space-evenly">
                        <div className="w-25">
                          <label
                            htmlFor="monthly_lunch_price"
                            className="mb-3 mt-4 block text-black dark:text-white pt-2"
                          >
                            <MealPlanPricingCheckBox
                              onChange={handlePricingCheckBox}
                              checkBoxId={'monthly_lunch_price'}
                              name={'Lunch'}
                            />
                          </label>
                        </div>
                      ...
                      <div className="gap-3 flex space-evenly">
                        <div className="w-25">
                          <label
                            htmlFor="monthly_dinner_price"
                            className="mb-3 mt-4 block text-black dark:text-white pt-2"
                          >
                            <MealPlanPricingCheckBox
                              onChange={handlePricingCheckBox}
                              checkBoxId={'monthly_dinner_price'}
                              name={'Dinner'}
                            />
                          </label>
                        </div>
                      ...
                      <div className=" w-full gap-3 rounded-lg border border-stroke px-5 pt-1 pb-4 item-center justify-center">
                        ...
                        <div className="gap-1 mb-3 lg:gap-5 flex flex-wrap justify-center md:justify-start space-evenly ">
                          <div className="gap-3 flex space-evenly">
                            <div className="w-25">
                              <label
                                htmlFor="monday_breakfast_dish"
                                className="mb-0 mt-4 block text-black dark:text-white pt-2"
                              >
                                <MealPlanPriceCheckbox
                                  checkboxDisabled={is_monday_available}
                                  DaysDishValue={monday_breakfast_dish}
                                  onChange={handlePricingCheckBox}
                                  checkBoxId={'monday_breakfast_dish'}
                                  name={'BreakFast'}
                                />
                              </label>
                            </div>
                          ...
                          <div className="gap-0 flex space-evenly">
                            <div className="w-20 ml-8">
                              <label
                                htmlFor="monday_breakfast_dish_option"
                        ...
                        <div className="gap-1 mb-3 lg:gap-5 flex flex-wrap justify-center md:justify-start space-evenly">
                          <div className="gap-3 flex space-evenly">
                            <div className="w-25">
                              <label
                                htmlFor="monday_lunch_dish"
                                className="mb-0 mt-4 block text-black dark:text-white pt-2"
                              >
                                <MealPlanPriceCheckbox
                                  checkboxDisabled={is_monday_available}
                                  onChange={handlePricingCheckBox}
                                  checkBoxId={'monday_lunch_dish'}
                                  name={'Lunch'}
                                />
                              </label>
                            </div>
                          ...
                          <div className="gap-0 flex space-evenly">
                            <div className="w-20 ml-8">
                              <label
                                htmlFor="monday_lunch_dish_option"
                                className="mb-3 mt-0 lg:mt-4 block text-black dark:text-white pt-1"
                              >
                                Options
                              </label>
                        ...
                        <div className="gap-1 mb-3 lg:gap-5 flex flex-wrap justify-center md:justify-start space-evenly">
                          <div className="gap-3 flex space-evenly">
                            <div className="w-25">
                              <label
                                htmlFor="monday_dinner_dish"
                                className="mb-0 mt-4 block text-black dark:text-white pt-2"
                              >
                                <MealPlanPriceCheckbox
                                  checkboxDisabled={is_monday_available}
                                  onChange={handlePricingCheckBox}
                                  checkBoxId={'monday_dinner_dish'}
                                  name={'Dinner'}
                                />
                              </label>
                            </div>
                          ...
                          <div className="gap-0 flex space-evenly">
                            <div className="w-20 ml-8">
                              <label
                                htmlFor="monday_dinner_dish_option"
                                className="mb-3 mt-0 lg:mt-4 block text-black dark:text-white pt-1"
                              >
                                Options
                              </label>
...
export default OrderManagementFormElements;
