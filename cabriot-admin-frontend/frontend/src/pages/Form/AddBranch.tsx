...
import BranchDataTable from '../../components/Tables/BranchDataTable';
...
const AddBranch = () => {
  ...
  const submitBranchGeneralInfo = async (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="Branch" pageTitle="Branch" />
      ...
      {form ? (
        ...
        <div>
          <div className="flex justify-between text-lg cursor-auto p-3 container bg-white rounded-lg">
            <div>
              <h1 className="text-xl p-2">Fill Branch Details.</h1>
            </div>
            <div>
              <h1
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between lg:space-x-12">
            <div className="mb-4 lg:w-full">
              <form onSubmit={submitBranchGeneralInfo}>
