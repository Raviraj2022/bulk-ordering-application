...
const CorporateMealPlanMenuDaysCheckbox: React.FC<MealPlanPriceCheckboxProps> = ({name, checkBoxId, onChange, checkboxDisabled}) => {
...
export default CorporateMealPlanMenuDaysCheckbox;
