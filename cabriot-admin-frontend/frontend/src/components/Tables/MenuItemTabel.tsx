...
const MenuItemTabel = () => {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`http://localhost:7000/api/menuitem/${id}`);
  ...
  useEffect(() => {
    ...
    axios
      .get('http://localhost:7000/api/menu/')
      .then((response) => {
        ...
        <div className="flex flex-col">
          <div className="grid grid-cols-7 rounded-sm dark:bg-meta-4">
            <div className="p-1 text-center">
              <h5 className="font-semibold">Dish Image</h5>
            </div>
            <div className="p-1 text-center">
              <h5 className="font-semibold">Dish Name</h5>
            </div>
            <div className="p-1 text-center">
              <h5 className="font-semibold">Base Price</h5>
            </div>
            <div className="p-1 text-center">
              <h5 className="font-semibold">Weight(gm)</h5>
            </div>
            <div className="p-1 text-center">
